        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-lg bg-kic-gold flex items-center justify-center">
                <span className="text-kic-dark font-bold text-xs">KIC</span>
              </div>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="hover:text-kic-gold transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="mailto:c.clulow@innovationcity.rw"
                  className="hover:text-kic-gold transition-colors"
                >
